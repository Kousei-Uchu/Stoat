...
/**
 * Custom hook to get the singleton PlayerQueue instance. Returns the same queue instance across all
 * components.
 *
 * ⚠️ IMPORTANT: This should only be called by: - useAudioPlayer (to pass to AudioPlayer
 * constructor) - useQueueOperations (to get operation methods)
 *
