...
// ─── Mark the document as mobile ─────────────────────────────────────────────
// The CSS rule `.mobile-platform #window-controls-container { display: none }`
// relies on this class being present before the first paint so the Electron
// window-chrome buttons (minimize / maximize / close) are never visible on mobile.
